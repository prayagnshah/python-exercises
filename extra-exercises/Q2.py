...
def sum_answer():
    ...
    num_1 = int(input("Enter the first number: "))     ##Asking the user to enter number 1
    num_2 = int(input('Enter the second number: '))   ##Asking the user to enter number 2

    answer = int(input("What is the answer? "))     ##Asking the user to enter the answer
    ...
    return f'The number of attempts is', count
...
# var = str(input("Do you want to try again (yes/no):" ))
